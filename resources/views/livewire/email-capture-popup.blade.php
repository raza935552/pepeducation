<div x-data="{
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div x-show="shown"
             ...
             role="dialog" aria-modal="true" aria-labelledby="email-popup-title">
            ...
            <div class="p-8">
                @if($success)
                    ...
                    <div class="text-center">
                        <div class="w-16 h-16 mx-auto mb-4 rounded-full bg-emerald-100 flex items-center justify-center">
                            <svg aria-hidden="true" class="w-8 h-8 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    ...
                    <div class="text-center mb-6">
                        ...
                        <h3 id="email-popup-title" class="text-2xl font-bold text-gray-900 mb-2">Stay Updated</h3>
                        <p class="text-gray-600">Get the latest peptide research, guides, and calculator updates delivered to your inbox.</p>
                    </div>
