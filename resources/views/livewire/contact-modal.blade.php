    ...
    @if($show)
        <div class="fixed inset-0 z-50 overflow-y-auto" x-data x-init="$el.querySelector('input')?.focus()">
            <div class="flex min-h-screen items-center justify-center p-4">
                ...
                {{-- Modal --}}
                <div class="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl" role="dialog" aria-modal="true" aria-labelledby="contact-modal-title" x-trap.inert.noscroll="true">
                    {{-- Header --}}
                    <div class="flex items-center justify-between p-6 border-b border-surface-200">
                        <h3 id="contact-modal-title" class="text-xl font-semibold text-gray-900">Contact Support</h3>
                    ...
                    @else
                        ...
                        <form wire:submit="submit" class="p-6 space-y-5">
                            <p class="text-sm text-gray-600">Have a question, feedback, or need help? We'd love to hear from you.</p>

                            <div class="grid sm:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Your Name *</label>
                                    <input type="text" wire:model="name" autocomplete="name" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500">
                                    @error('name') <p class="mt-1 text-sm text-red-500">{{ $message }}</p> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email Address *</label>
                                    <input type="email" wire:model="email" autocomplete="email" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500">
                            ...
                            <div>
                                ...
                                <select wire:model="subject" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500">
                            ...
                            <div>
                                ...
                                <textarea wire:model="message" rows="4" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500" placeholder="Tell us how we can help..."></textarea>
                            ...
                            <div class="flex justify-end gap-3">
                                ...
                                <button type="submit" class="px-6 py-2.5 bg-primary-500 text-white rounded-full font-medium hover:bg-primary-600" wire:loading.attr="disabled">
