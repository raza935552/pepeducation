                        ...
                        <form wire:submit="submit" class="p-6 space-y-5">
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" wire:model="name" autocomplete="name" class="w-full rounded-lg border-cream-200 focus:ring-gold-500 focus:border-gold-500">
                                    @error('name') <p class="mt-1 text-sm text-red-500">{{ $message }}</p> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Email Address *</label>
                                    <input type="email" wire:model="email" autocomplete="email" class="w-full rounded-lg border-cream-200 focus:ring-gold-500 focus:border-gold-500">
                            ...
                            <div>
                                ...
                                <select wire:model="subject" class="w-full rounded-lg border-cream-200 focus:ring-gold-500 focus:border-gold-500">
                            ...
                            <div>
                                ...
                                <textarea wire:model="message" rows="4" class="w-full rounded-lg border-cream-200 focus:ring-gold-500 focus:border-gold-500" placeholder="Tell us how we can help..."></textarea>
