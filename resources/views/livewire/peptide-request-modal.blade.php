                    ...
                    @else
                        ...
                        <form wire:submit="submit" class="p-6 space-y-5">
                            <div>
                                ...
                                <input type="text" wire:model="peptideName" placeholder="e.g., Epithalon, MOTS-c, etc." class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500">
                            ...
                            <div>
                                ...
                                <textarea wire:model="sourceLinks" rows="4" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500" placeholder="Please provide links to research papers, clinical trials, or reputable sources (one per line)"></textarea>
                            ...
                            <div>
                                ...
                                <textarea wire:model="notes" rows="2" class="w-full rounded-lg border-surface-200 focus:ring-primary-500 focus:border-primary-500" placeholder="Any additional information..."></textarea>
                            </div>
