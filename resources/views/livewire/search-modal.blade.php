        ...
        >
            ...
            <div class="relative border-b border-brown-700/50">
                ...
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                    <svg class="h-5 w-5 text-cream-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                ...
                <div wire:loading wire:target="search" class="absolute inset-y-0 right-0 flex items-center pr-4">
                    <svg class="h-5 w-5 animate-spin text-gold-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            ...
                            @foreach($this->results as $index => $result)
                                ...
                                >
                                    ...
                                    <div class="{{ $selectedIndex === $index ? 'opacity-100' : 'opacity-0 group-hover:opacity-50' }} transition-opacity">
                                        <svg class="h-5 w-5 text-cream-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    @else
                        ...
                        <div class="px-6 py-12 text-center">
                            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-brown-700/50">
                                <svg class="h-6 w-6 text-cream-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-y-1">
                            <a href="{{ route('peptides.index') }}" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-cream-300 transition-colors hover:bg-brown-700/50 hover:text-cream-100">
                                ...
                                <svg class="h-4 w-4 text-brown-600 transition-colors group-hover:text-cream-500" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="mt-4 rounded-xl bg-brown-700/30 px-4 py-3">
                            <p class="flex items-center gap-2 text-xs text-cream-500">
                                <svg class="h-4 w-4 flex-shrink-0 text-gold-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
