<x-account-layout>
    <div class="space-y-6">
        ...
        {{-- Profile Form --}}
        <form action="{{ route('account.profile.update') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-cream-200 p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}"
                           class="w-full rounded-lg border-cream-200 focus:ring-gold-500 focus:border-gold-500">
                    @error('name')
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    <input type="email" value="{{ $user->email }}" disabled
                           class="flex-1 rounded-lg border-cream-200 bg-cream-50 cursor-not-allowed">
