...
<div class="card border-l-4 border-l-amber-500">
    ...
    <div class="space-y-3">
        @foreach($peptide->safety_warnings as $warning)
            <div class="flex items-start gap-3 p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/30">
                <span class="shrink-0 mt-0.5 flex items-center justify-center w-5 h-5 rounded-full bg-amber-100 dark:bg-amber-900/50">
                ...
                <span class="text-gray-700 dark:text-cream-300">{{ $warning }}</span>
            </div>
        @endforeach
    </div>
</div>
