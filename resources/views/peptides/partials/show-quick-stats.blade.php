<div class="card">
    <h3 class="section-heading">
        <span class="section-icon-sm bg-gradient-to-br from-primary-400 to-primary-600 shadow-primary-500/30">
    ...
    <dl class="space-y-3">
        ...
        <div class="py-2 border-b border-surface-200">
            <dt class="text-sm text-gray-500 mb-2">Injection Sites</dt>
            <dd class="flex flex-wrap gap-1.5">
                @foreach($peptide->injection_sites as $site)
                    <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-primary-100 text-primary-700">
                        {{ $site }}
                    </span>
                @endforeach
            </dd>
