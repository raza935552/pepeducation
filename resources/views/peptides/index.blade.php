        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-sm text-gray-500">Research Level:</span>
            ...
            <div class="mb-6">
                <p class="text-gray-600">
                    Showing <span class="font-semibold text-gray-900">{{ $peptides->firstItem() ?? 0 }}-{{ $peptides->lastItem() ?? 0 }}</span>
                    of <span class="font-semibold text-gray-900">{{ $peptides->total() }}</span> peptides
                </p>
            </div>
