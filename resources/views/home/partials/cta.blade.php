...
<section class="py-16 lg:py-20 bg-surface-100 relative overflow-hidden">
    {{-- Decorative elements --}}
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
            {{-- Icon --}}
            <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center mx-auto mb-6 shadow-lg shadow-primary-500/20">
            ...
            <p class="text-sm text-gray-500 flex items-center justify-center gap-2">
                <svg aria-hidden="true" class="w-4 h-4 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
