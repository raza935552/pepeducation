            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="{{ route('peptides.index') }}"
                       class="inline-flex items-center justify-center px-8 py-4 bg-white text-secondary-600 font-semibold rounded-full hover:bg-surface-100 transition-all duration-300 shadow-lg hover:shadow-xl">
                        Get Started
