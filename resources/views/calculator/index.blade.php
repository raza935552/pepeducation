<x-public-layout>
    ...
    <!-- Hero Section -->
    <section class="bg-cream-100 dark:bg-brown-900 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-cream-100 mb-4">
                    Peptide <span class="text-gold-500 dark:text-gold-400">Calculator</span>
                </h1>
                <p class="text-lg text-gray-600 dark:text-cream-400">
    ...
    <!-- Calculator Section -->
    <section class="py-12 bg-cream-50 dark:bg-brown-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <!-- Info Section -->
    <section class="py-12 bg-white dark:bg-brown-900">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-cream-100 mb-6">
                How to Use This Calculator
            </h2>

            <div class="space-y-6">
                <div class="bg-cream-50 dark:bg-brown-800 rounded-xl p-6">
                    <h3 class="font-semibold text-gray-900 dark:text-cream-100 mb-2 flex items-center gap-2">
                    ...
                    <p class="text-gray-600 dark:text-cream-400 ml-8">
            ...
            <div class="mt-8 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-6">
                <div class="flex gap-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-amber-800 dark:text-amber-300 mb-1">Research Purposes Only</h4>
