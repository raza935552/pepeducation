{{-- Tirzepatide titration schedule widget --}}
<div x-data="tirzTitration()" class="space-y-6">
...
<script>
    function tirzTitration() {
        const ladder = [2.5, 5, 7.5, 10, 12.5, 15];
        const today = new Date().toISOString().slice(0, 10);
        const defaults = { start: today, weeksPerStep: 4, maxDose: 15 };
        return {
