    ...
    <div class="grid md:grid-cols-2">
        ...
        <div class="p-6 sm:p-8 bg-surface-50 border-t md:border-t-0 md:border-l border-gray-200 flex flex-col">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5 mb-4 text-center">
                ...
                <p class="text-5xl font-bold" :style="`color: ${categoryColor}`" x-text="bmi"></p>
...
<script>
    function bmiCalc() {
        return {
            units: 'metric', cm: 175, kg: 75, ft: 5, inch: 9, lb: 165,
            get heightM() {
            ...
            get healthyRange() {
                ...
                if (this.units === 'metric') return `${lo.toFixed(1)}–${hi.toFixed(1)} kg`;
                return `${(lo / 0.453592).toFixed(0)}–${(hi / 0.453592).toFixed(0)} lb`;
            },
        };
    }
</script>
