    ...
    <section class="bg-gradient-to-b from-cream-100 to-cream-50 dark:from-brown-900 dark:to-brown-900 py-16 lg:py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-cream-100 mb-6">
                About <span class="text-gold-500 dark:text-gold-400">PepProfesor</span>
            </h1>
            <p class="text-lg text-gray-600 dark:text-cream-300 max-w-2xl mx-auto">
    ...
    <section class="py-16 lg:py-24">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="prose prose-lg dark:prose-invert max-w-none">
                {{-- Mission --}}
                <div class="bg-white dark:bg-brown-800 rounded-2xl p-8 border border-cream-200 dark:border-brown-700 mb-8">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-cream-100 m-0">Our Mission</h2>
                    </div>
                    <p class="text-gray-600 dark:text-cream-300 m-0">
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl p-8 border border-cream-200 dark:border-brown-700 mb-8">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-cream-100 m-0">What We Offer</h2>
                    </div>
                    <ul class="space-y-3 text-gray-600 dark:text-cream-300 m-0 list-none p-0">
                ...
                <div class="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-8 border border-amber-200 dark:border-amber-800">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-cream-100 m-0">Important Note</h2>
                    </div>
                    <p class="text-gray-600 dark:text-cream-300 m-0">
                        PepProfesor is for educational and research purposes only. We do not sell peptides or provide medical advice. Always consult qualified healthcare professionals before making any decisions related to your health. See our <a href="{{ route('disclaimer') }}" class="text-gold-600 dark:text-gold-400 hover:underline">full disclaimer</a> for more information.
                    </p>
                </div>
            </div>
        </div>
