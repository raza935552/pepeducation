<x-public-layout title="FAQ">
    ...
    <section class="bg-gradient-to-b from-cream-100 to-cream-50 dark:from-brown-900 dark:to-brown-900 py-16 lg:py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-gray-600 dark:text-cream-300">
    ...
    <section class="py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="space-y-4" x-data="{ open: 1 }">
                {{-- FAQ 1 --}}
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 1 ? null : 1" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">What is PepProfesor?</span>
                    ...
                    <div x-show="open === 1" x-collapse>
                        <div class="px-6 pb-5 text-gray-600 dark:text-cream-300">
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 2 ? null : 2" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">Do you sell peptides?</span>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 3 ? null : 3" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">Is the information here medical advice?</span>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 4 ? null : 4" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">How do I use the dosing calculator?</span>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 5 ? null : 5" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">How can I contribute to PepProfesor?</span>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 6 ? null : 6" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">Is PepProfesor free to use?</span>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 7 ? null : 7" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">Where does your information come from?</span>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" :class="{ 'rotate-180': open === 7 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                ...
                <div class="bg-white dark:bg-brown-800 rounded-2xl border border-cream-200 dark:border-brown-700 overflow-hidden">
                    <button @click="open = open === 8 ? null : 8" class="w-full px-6 py-5 text-left flex items-center justify-between gap-4">
                        <span class="font-semibold text-gray-900 dark:text-cream-100">How can I contact you?</span>
                        <svg class="w-5 h-5 text-gray-500 transition-transform" :class="{ 'rotate-180': open === 8 }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    <div x-show="open === 8" x-collapse>
                        <div class="px-6 pb-5 text-gray-600 dark:text-cream-300">
                            You can reach us through our <button onclick="Livewire.dispatch('openContactModal')" class="text-gold-600 dark:text-gold-400 hover:underline">contact form</button>. We typically respond within 1-2 business days.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 text-center">
                <p class="text-gray-600 dark:text-cream-300 mb-4">Still have questions?</p>
