            ...
            @foreach($categories as $cat)
                <li>
                    <a href="{{ route('blog.category', $cat) }}"
                       class="flex items-center justify-between py-1.5 text-sm {{ isset($category) && $category->id === $cat->id ? 'text-dark-700 font-semibold' : 'text-gray-600 hover:text-dark-700' }} transition-colors">
                    ...
                    <li>
                        <a href="{{ route('blog.show', $popular->slug) }}" class="group flex gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <h4 class="text-sm font-medium text-gray-900 line-clamp-2 group-hover:text-dark-700 transition-colors">
                                    {{ $popular->title }}
                                </h4>
