        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="font-medium text-gray-900">
                    ...
                    @if($supporter->is_featured)
                        <span class="ml-1 text-gold-500" title="Featured">
                            <svg aria-hidden="true" class="w-4 h-4 inline" fill="currentColor" viewBox="0 0 20 20">
                ...
                @if($supporter->website_url)
                    <a href="{{ $supporter->website_url }}" target="_blank" rel="noopener" class="text-sm text-gray-500 hover:text-gold-500">
    ...
    <td class="px-6 py-4 text-right">
        <div class="flex items-center justify-end gap-2">
            <a href="{{ route('admin.supporters.edit', $supporter) }}"
               class="p-2 text-gray-500 hover:text-gold-600 transition-colors"
               title="Edit">
