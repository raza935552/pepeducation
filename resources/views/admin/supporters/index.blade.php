<x-admin-layout title="Supporters">
    ...
    <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <form method="GET" class="flex flex-wrap gap-4">
            ...
            <select name="tier" class="rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white text-sm">
            ...
            @if(request()->hasAny(['search', 'tier', 'status']))
                <a href="{{ route('admin.supporters.index') }}" class="px-4 py-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 text-sm">
                    Clear
                </a>
            @endif
        </form>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        @if($supporters->isEmpty())
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 dark:text-gray-400">No supporters found.</p>
        ...
        @else
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Supporter</th>
