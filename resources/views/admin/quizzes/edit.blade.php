    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                @endif
                <a href="{{ route('admin.quizzes.export', $quiz) }}" class="btn btn-secondary text-sm inline-flex items-center gap-2" title="Download all slides as .txt for Claude briefing">
