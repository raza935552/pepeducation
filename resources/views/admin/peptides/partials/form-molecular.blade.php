<div class="card">
    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Molecular & Pharmacokinetics</h3>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <!-- Molecular Weight -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Molecular Weight (Da)</label>
        ...
        <!-- Amino Acid Length -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Amino Acid Length</label>
        ...
        <!-- Peak Time -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Peak Time</label>
        ...
        <!-- Half Life -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Half Life</label>
        ...
        <!-- Clearance Time -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Clearance Time</label>
