            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('admin.bugs.index') }}"
                       class="{{ request()->routeIs('admin.bugs.*') ? 'bg-gray-100 text-primary-600' : 'text-gray-700 hover:bg-gray-100' }} group flex gap-x-3 rounded-lg p-2 text-sm font-semibold leading-6 transition-colors">
                        <svg aria-hidden="true" class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <ul role="list" class="-mx-2 mt-2 space-y-1">
                ...
                <li>
                    <a href="{{ route('admin.results-bank.index') }}"
                       class="{{ request()->routeIs('admin.results-bank.*') ? 'bg-gray-100 text-primary-600' : 'text-gray-700 hover:bg-gray-100' }} group flex gap-x-3 rounded-lg p-2 text-sm font-semibold leading-6 transition-colors">
                        <svg aria-hidden="true" class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
