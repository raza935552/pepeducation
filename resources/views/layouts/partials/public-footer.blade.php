                    ...
                    @foreach($supporters as $supporter)
                        @if($supporter->website_url)
                            <a href="{{ $supporter->website_url }}" target="_blank" rel="noopener noreferrer"
                               class="group flex items-center gap-2 px-4 py-2 rounded-lg bg-dark-800/50 hover:bg-dark-800 transition-colors"
                               title="{{ $supporter->name }}">
                        @else
                            <div class="flex items-center gap-2 px-4 py-2 rounded-lg bg-dark-800/50">
                        @endif
                            @if($supporter->logo)
                            ...
                            @else
                                <span class="text-sm font-medium text-surface-300 {{ $supporter->website_url ? 'group-hover:text-primary-400 transition-colors' : '' }}">
                                    {{ $supporter->name }}
                                </span>
                            @endif
