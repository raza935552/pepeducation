...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/funnel', [\App\Http\Controllers\Admin\FunnelController::class, 'index'])->name('funnel');
    ...
    Route::patch('quizzes/{quiz}/questions/{question}/move', [QuizQuestionController::class, 'move'])->name('quizzes.questions.move');
    ...
    // Insights & Analytics
    Route::get('insights', [\App\Http\Controllers\Admin\InsightsController::class, 'index'])->name('insights.index');
